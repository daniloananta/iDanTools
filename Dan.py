...
def keyword_list():
        global keyword_top
        keyword_top.append('LANGSUNG')
        keyword_top.append('SAJA')
        keyword_top.append('KITA')
        keyword_top.append('DDOS')
        keyword_top.append('SERVER')
        keyword_top.append('EPIC')
        keyword_top.append('ITU')
        keyword_top.append('Knock Knock')
        keyword_top.append('Toast')
        keyword_top.append('YEABOI')
        keyword_top.append('OFC')
        keyword_top.append('NOONE')
        keyword_top.append('Wild and Wet')
        keyword_top.append('1000')
        ...
        keyword_top.append('SHITBOI')
        keyword_top.append('FUCKED')
        keyword_top.append('Anonymous')
        keyword_top.append('TOOLERS')
...
def helptext ():
        print ""
        print "|-->Subcribe ImDanilo
        print "|"
        print "|-->Tools Coded By : iDan#6102
        print "|"
        print "|-->To Stop The DDOS Pres Ctrl+C [ for termux ] & Ctrl+X [ for PC ]"
        print "|==============================================================================|" 
        exit()
...
def sender (num):
        ...
        col()
        print " * | Krypto  BOT Attacking %d [69]" % num
